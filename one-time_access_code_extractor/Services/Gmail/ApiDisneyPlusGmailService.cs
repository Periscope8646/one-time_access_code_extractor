...
public interface IApiDisneyPlusGmailService
{
...
public class ApiDisneyPlusGmailService : GmailAuthorizedServiceBase, IApiDisneyPlusGmailService
{
    private readonly IGmailServiceHelper _gmailServiceHelper;

    public ApiDisneyPlusGmailService(IGoogleAuthService googleAuthService,
        ILogger<ApiDisneyPlusGmailService> logger,
